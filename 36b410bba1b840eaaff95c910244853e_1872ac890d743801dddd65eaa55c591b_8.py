    ...
    def getWebList(self,url):
        ...
        while True:
            ...
            try:
                ...
                self.logger.error(url+traceback.format_exc())
                break
        webdict=self.db.geturl().keys()
        pool = ThreadPool(4)
...
def main():
    url=["http://www.mm131.com/xinggan/","http://www.mm131.com/qingchun/","http://www.mm131.com/xiaohua/","http://www.mm131.com/chemo/"]
    sp=spider()
